...
const NavBar = () => {
    ...
    return (
        <div>
            <div className="navbar bg-[#a68a2e] text-[#FFFDD0]">
                <div className="navbar-start w-max">
                    <div className="dropdown">
                        <label tabIndex={0} className="btn btn-ghost lg:hidden">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" /></svg>
                        </label>
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-[#a68a2e] rounded-box w-52 ">
                            {navli}
                        </ul>
                    </div>
                    <div className='w-20 '>
                ...
                <div className="navbar-end hidden lg:flex ml-auto">
                    <ul className="menu menu-horizontal font-medium px-2 ">
                        {navli}
                    </ul>
                </div>
                {/* // #51434a #FFFDD0 */}
